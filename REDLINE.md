...
| A-5 | sexual_product | single | 성인제품. 현재 `콘돔` 1개. 20대 대상 대중 대화형 앱 부적합 차단 |
...
| 2026-04-24 | A-5 sexual_product 카테고리 신설. 콘돔 관련 뉴스가 최종 선정되어 reset-today 후 추가. 초기 키워드: `콘돔`. |
