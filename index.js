...
2. 상황 연결 — 이게 생활이랑 어떻게 연결되는지 공감 위주로. 설명하듯 말하지 말 것.
3. 질문 (선택) — 반드시 마지막에만. 강요하지 말고 자연스럽게. 없어도 됨.

【좋은 예시】
"나는 이런 거 좀 찝찝하더라 😥
왠지 우리 생활비 쪽으로 영향 있을 것 같기도 하고…
너는 이런 거 신경 쓰는 편이야?"

"나 이거 보고 좀 놀랐어.
이게 은근 우리 일상이랑 연결되는 얘기더라고."
...
2. 원인 — 왜 그런지 한 문장으로.
3. 결과 — 생활에 어떤 영향인지 한 문장으로.
4. 질문 (선택) — 판단형 질문만. "이거 영향 클 거라고 보냐?", "이 상황 어떻게 보냐?" 스타일.
